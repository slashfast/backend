...
export const REST_API = {
    ...
    BANDWIDTH_STATS: {
        ...
        INBOUNDS: {
            GET_USAGE: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.BANDWIDTH_STATS_CONTROLLER}/${CONTROLLERS.BANDWIDTH_STATS_INBOUNDS_ROUTE}/${CONTROLLERS.BANDWIDTH_STATS_ROUTES.INBOUNDS.GET_USAGE(uuid)}`,
            USER_USAGE: (uuid: string, userId: string) =>
                `${ROOT}/${CONTROLLERS.BANDWIDTH_STATS_CONTROLLER}/${CONTROLLERS.BANDWIDTH_STATS_INBOUNDS_ROUTE}/${CONTROLLERS.BANDWIDTH_STATS_ROUTES.INBOUNDS.USER_USAGE(uuid, userId)}`,
            GET_TOP_USERS: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.BANDWIDTH_STATS_CONTROLLER}/${CONTROLLERS.BANDWIDTH_STATS_INBOUNDS_ROUTE}/${CONTROLLERS.BANDWIDTH_STATS_ROUTES.INBOUNDS.GET_TOP_USERS(uuid)}`,
        },
    },
    CONNECTIONS: {
